...
export const People = ({ people, setPeople }) => {
  ...
  return (
    <div>
      ...
      {/* Formulario */}
      <div className='container'>
        <h2 className='text-center mt-4' > {isEditing ? 'Actualize Worker' : 'Create new worker'} </h2>
        <form>
          <div>
          ...
          <div className="mt-2 text-center">
            <button type="submit" className="btn btn-primary" onClick={isEditing ? handleSave : handleCreate}> {isEditing ? 'Actualize' : 'Create'} </button>
          </div>
        </form>
      </div>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p>¿Are you sure you want to delete {people.find(person => person.id === personToDelete)?.name} ?</p>
            </div>
